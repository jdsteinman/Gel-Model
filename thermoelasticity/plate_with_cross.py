...
def main():
    ...
    params['output_folder'] = './output/plate_with_cross/'
...
def solver_call(params):
    ...
    T_expr = TempExpression(domains=domains, dT_x=1e-6, dT_y=-1e-6)
    ...
    solver.parameters['newton_solver']['maximum_iterations'] = 100000
