...
Fenics simulation of hyperelastic ellipsoidal model
- outputs:
...
def main():
    ...
    ## Run Sim ==================================================================================
    # Breaking prescribed boundary conditions into several smaller displacements to help with convergence.
    # Should solve in one "chunk" for small BCs
