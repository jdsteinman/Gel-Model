...
"""Implementation of finite-dimension plate with inclusion problem for Cosserat
elasticity in DOLFIN finite element problem solving environment.
...
def parameter_study():
    ...
    params['L'] = 1.1 
    mesh_dir = "meshes/finite_plate_with_circular_inclusion_%.1f/" % params['L']
    params['output_dir'] = 'output/finite_plate_with_circular_inclusion/'
    ...
    result = finite_plate_with_inclusion(params) 
    print result['maximum_stress']
...
def main():
    ...
    mesh_dir = "meshes/finite_plate_with_circular_inclusion_1.1/"
    params['output_dir'] = 'output/finite_plate_with_circular_inclusion/'
...
def finite_plate_with_inclusion(params):
    mesh = params['mesh']
    # Displacement space
