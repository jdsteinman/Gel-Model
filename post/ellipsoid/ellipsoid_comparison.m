...
vertices = textread(strcat('./ellipsoid/vertices.txt'));
surf_vertices = textread(strcat('./ellipsoid/surf_vertices.txt'));
faces = textread(strcat('./ellipsoid/surf_faces.txt'));
faces = faces+1;
...
% Experimental data
disp_real = textread(strcat(sim_path, 'vertex_disp_12.txt')); 

% Simulation Data
disp_sim = textread(strcat(sim_path, 'vertex_disp_13.txt')); 
