...
data_path = '../data/Gel3/';
output_path = '../gel_model/output/Gel3/';
...
% Experimental data
disp_real = csvread(strcat(data_path, 'displacements_cytod_to_normal_uncentered_unpca.csv')); 

% Simulation Data
disp_sim = textread(strcat(output_path, 'sim_beads_disp.txt')); 

% Which displacement to use
