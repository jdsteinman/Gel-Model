function triangle_mesh_vtkwrite( filename,dataType,varargin )

%% My own implementation for triangle meshes
% triangle_mesh_vtkwrite(filename,'polydata','triangle',x,y,z,faces,'vectors',title,Ux,Uy,Uz,'scalars',title2,U)
% filename - what you want your vtk file to be called
% polydata - means it's a mesh
% triangle - specifies triangle
% x,y,z - cartesian vertices coordinates
% faces - connectivity of vertices
% 'vectors' - specifies you will have vectors
% title - name of the vectors
% Ux,Uy,Uz - components of vectors
% 'scalars' - specifies you will have a scalar field
% title2 - name of the scalar field
% U - scalar field
%% 
...
%                 fwrite(fid, reshape(varargin{sidx(ii)+2},1,n_elements),'float','b');
    ...
    case 'POLYDATA'
        ...
        elseif mod(n_elements,3)==2
            x(n_elements+1,1)=0; y(n_elements+1,1)=0;
            z(n_elements+1,1)=0;
        end
        nbpoint = numel(x);
