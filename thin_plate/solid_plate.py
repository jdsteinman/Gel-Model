...
def main():
    ...
    params['output_folder'] = './output/three_field/plate/' + params['case'] + '/'

    params['mesh'] = df.Mesh("./meshes/solid_plate.xml")

    params['physical_region'] = df.MeshFunction("size_t", params["mesh"], "./meshes/solid_plate_physical_region.xml")
    params['facet_region'] = df.MeshFunction("size_t", params["mesh"], "./meshes/solid_plate_facet_region.xml")
