...
#sides = CompiledSubDomain("on_boundary && !near(x[0], side1) && !near(x[0], side2)", side1=0.0, side2=10.0)
sides = CompiledSubDomain("on_boundary && (near(abs(x[1]), 0.5) || near(abs(x[2]), 0.5))")

zero = Constant((0.0, 0.0, 0.0))
u_b = Constant((-0.1, 0.0, 0.0))
